...
alias redis-server="~/Programs/redis-stable/src/redis-server"
alias redis-cli="~/Programs/redis-stable/src/redis-cli"

alias python-smtp-debug="python -m smtpd -n -c DebuggingServer localhost:1025"
alias python-simpleServer8002="python -m SimpleHTTPServer 8002"
